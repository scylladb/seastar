...
public:
    ...
    /// exceeding it are rejected with 414 URI Too Long or 431 Request Header
    /// Fields Too Large before the handler runs, bounding the memory a client
    /// can force the server to buffer. Defaults to 32 KiB.
