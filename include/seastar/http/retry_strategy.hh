...
public:
    default_connection_reset_strategy(unsigned max_retries, unsigned scale_factor, retry_requests client_should_retry);
    explicit default_connection_reset_strategy(retry_requests client_should_retry);
    ...
    [[nodiscard]] unsigned get_max_retries() const override;
};
