...
struct request {
    ...
    http::shared_body_writer_type body_writer; // for client
     ...
     *
     */
    void write_body(const sstring& content_type, http::shared_body_writer_type body_writer);

    void write_body(const sstring& content_type, http::body_writer_type&& body_writer) {
        write_body(content_type, http::make_shared_body_writer_type(std::move(body_writer)));
    }
     ...
     *
     */
    void write_body(const sstring& content_type, size_t len, http::shared_body_writer_type body_writer);

    void write_body(const sstring& content_type, size_t len, http::body_writer_type&& body_writer) {
        return write_body(content_type, len, http::make_shared_body_writer_type(std::move(body_writer)));
    }
