...
using shared_body_writer_type = lw_shared_ptr<body_writer_type>;

inline shared_body_writer_type make_shared_body_writer_type(body_writer_type&& body_writer) {
    return make_lw_shared(std::move(body_writer));
}
