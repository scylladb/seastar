...
data_source make_file_data_source(file, uint64_t offset, uint64_t len, file_input_stream_options) noexcept;

/// Create a data_source for reading the whole file from start to end
data_source make_file_data_source(file, file_input_stream_options) noexcept;
