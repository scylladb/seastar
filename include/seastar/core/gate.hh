...
inline void named_gate::assert_not_held_when_moved() const noexcept {
    SEASTAR_ASSERT(_holders.empty() && "named_gate moved with outstanding holders");
}
inline void named_gate::assert_not_held_when_destroyed() const noexcept {
    SEASTAR_ASSERT(_holders.empty() && "named_gate destroyed with outstanding holders");
}
#endif  // SEASTAR_GATE_HOLDER_DEBUG
