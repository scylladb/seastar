...
/// If both the coroutine and one or more finally func throws, the final exception
/// will be a seastar::nested_exception containing all of them, with the inner-most
/// exception being the one from the coroutine.
///
