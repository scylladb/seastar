...
public:
    ...
    coroutine_handle<> await_suspend(coroutine_handle<promise_type> coro, slim_source_location sl = {}) noexcept;
...
public:
    ...
    void await_suspend(coroutine_handle<Promise> coro, slim_source_location sl = {}) noexcept {
...
coroutine_handle<> yield_awaiter<T, Container>::await_suspend(
    coroutine_handle<generator_buffered_promise<T, Container>> coro, slim_source_location sl) noexcept {
    coro.promise().update_resume_point(sl);
