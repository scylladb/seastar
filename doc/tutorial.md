...
`coroutine::finally` is a facility to make this easier.
...
The lambda passed to `coroutine::finally` should not capture local variables by references, as it will be run after the coroutine frame is destroyed.
