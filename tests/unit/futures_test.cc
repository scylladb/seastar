...
SEASTAR_TEST_CASE(futurize_apply_val_exception) {
    return futurize<int>::invoke([] (int arg) { throw expected_exception(); return arg; }, 1).then_wrapped([] (future<int> f) {
        try {
            f.get();
...
SEASTAR_TEST_CASE(futurize_apply_val_ok) {
    return futurize<int>::invoke([] (int arg) { return arg * 2; }, 2).then_wrapped([] (future<int> f) {
        try {
            auto x = f.get0();
...
SEASTAR_TEST_CASE(futurize_apply_val_future_exception) {
    return futurize<int>::invoke([] (int a) {
...
SEASTAR_TEST_CASE(futurize_apply_void_exception) {
    return futurize<void>::invoke([] (auto arg) { throw expected_exception(); }, 0).then_wrapped([] (future<> f) {
        try {
            f.get();
            BOOST_FAIL("should have thrown");
        } catch (expected_exception& e) {}
...
SEASTAR_TEST_CASE(futurize_apply_void_ok) {
    return futurize<void>::invoke([] (auto arg) { }, 0).then_wrapped([] (future<> f) {
        try {
            f.get();
        } catch (expected_exception& e) {
            BOOST_FAIL("should not have thrown");
...
SEASTAR_TEST_CASE(futurize_apply_void_future_exception) {
    return futurize<void>::invoke([] (auto a) {
        return sleep(std::chrono::milliseconds(100)).then([] {
            throw expected_exception();
        });
...
SEASTAR_TEST_CASE(futurize_apply_void_future_ok) {
    ...
    return futurize<void>::invoke([] (int& a) {
        return sleep(std::chrono::milliseconds(100)).then([&a] {
            a *= 100;
        });
