...
static const std::unordered_map<reply::status_type, std::string_view> status_strings = {
    ...
    {reply::status_type::moved_temporarily, "302 Found"},
    ...
    {reply::status_type::proxy_authentication_required, "407 Proxy Authentication Required"},
    ...
    {reply::status_type::precondition_failed, "412 Precondition Failed"},
    {reply::status_type::payload_too_large, "413 Content Too Large"},
    {reply::status_type::uri_too_long, "414 URI Too Long"},
    {reply::status_type::unsupported_media_type, "415 Unsupported Media Type"},
    {reply::status_type::range_not_satisfiable, "416 Range Not Satisfiable"},
    {reply::status_type::expectation_failed, "417 Expectation Failed"},
    {reply::status_type::misdirected_request, "421 Misdirected Request"},
    {reply::status_type::unprocessable_entity, "422 Unprocessable Content"},
