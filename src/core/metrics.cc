...
namespace {
/*
 * Which shard(s) registered each local_shard_only() family, so a filtered
 * scrape can skip the rest. Hinted registrations are rare enough for a
 * cross-shard mutex (as in seastar::logger_registry).
 */
