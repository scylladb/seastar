...
std::vector<seastar::metrics::impl::metric_definition_impl> io_queue::priority_class_data::metrics() {
    ...
    return std::vector<sm::impl::metric_definition_impl>({
            ...
            sm::make_counter("integral_queue_length", [this] { return _nr_queued.integral(); }, sm::description("Integrated queue length")),
            sm::make_counter("integral_disk_queue_length", [this] { return _nr_executing.integral(); }, sm::description("Integrated disk queue length")),
    });
}
