...
macro (seastar_find_dependencies)
  ...
  if (Seastar_IMPORT_FMT AND Seastar_FMT_VERSION)
    # A consumer of the installed package that imports fmt must get the very
    # fmt Seastar was built with: SEASTAR_FMT_VERSION is baked into
    # Seastar::seastar, since fmt's module does not export FMT_VERSION, and
    # the module's API varies between versions, even patch releases.
    seastar_find_dep (fmt ${Seastar_FMT_VERSION} EXACT REQUIRED)
  else ()
